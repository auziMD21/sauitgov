...
<section class="panel">
    ...
    <div class="panel-body">
        <form action="<?= base_url() ?>admin/tambahpertanyaan" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-md-3 control-label">Pertanyaan</label>
                <div class="col-md-6">
                    <textarea  name="pertanyaan" class="form-control" placeholder="Pertanyaan" required></textarea>
                </div>
            </div>
            <div class="form-group">
