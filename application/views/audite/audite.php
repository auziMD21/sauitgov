    ...
    <div class="col-xs-12">
        <section class="panel form-wizard" id="w4">
            ...
            <div class="panel-body">
                <p><a class="btn btn-primary" href="<?= base_url() ?>perusahaan/insert_audite">+ tambah audite</a></p>
                    ...
                    <?php $n = 1; foreach ($tampil as $u){ ?>
                        <tr>
                            ...
                            <td>
                                ...
                                if($u->status==0) {
                                    ?>
                                    <a href="<?=base_url('audite/updateStatus/'.$u->id.'/1')?>"class="btn btn-xs btn-warning">Berikan Akses</a>
                                <?php }
                                else{
                                    ?>
                            ...
                            <td>
                                <a class="btn btn-xs btn-default" alt="Edit" href="<?= base_url() ?>perusahaan/form_audite/<?= $u->id ?>"><li class="fa fa-edit"></li></a>
                                <a class="btn btn-xs btn-primary" alt="Lihat" href="<?= base_url() ?>perusahaan/lihataudite/<?= $u->id ?>"><li class="fa fa-eye"></li></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
                ...
                <br>
                <br>
                <p><a class="btn btn-default" href="<?= base_url() ?>perusahaan/home">Back to Home</a></p>
