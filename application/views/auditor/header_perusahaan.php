...
<section class="body">
    ...
    <header class="header">
        <div class="logo-container">
            <a href="<?= base_url() ?>/auditor/home" class="logo">
            ...
            <div id="userbox" class="userbox">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled">
                        <li class="divider"></li>
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?= base_url() ?>auditor/profil"><i class="fa fa-user"></i> <?= $this->session->userdata('username') ?></a>
                        </li>
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?= base_url() ?>auditor/audite"><i class="fa fa-users"></i> Audite</a>
                        </li>
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?= base_url() ?>auditor/histori_audit"><i class="fa fa-history"></i>Histori Audit</a>
                        </li>
                        <li>
