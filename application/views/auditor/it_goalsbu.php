            ...
            <div class="panel-body">
                <div class="wizard-progress wizard-progress-lg">
                    ...
                    <ul class="wizard-steps">
                        <li class="">
                            <a href="#w4-misi" data-toggle="tab"><span>1</span>Permasalah</a>
                        </li>
                        <li>
                        ...
                        <div id="w4-misi" class="tab-pane active">
                            <div id="w4-itg" class="tab-pane">
                                ...
                                <table class="table table-bordered table-striped" id="datatable-edittable">
                                    <thead>
                                    <tr>
                                        <th>Bussines Goals Perusahaan</th>
                                        <th>IT Goals COBIT 4.1</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?= $isiTable ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-1">
                                    <a href="<?= base_url('auditor/buttomup/it_processbu') ?>" class="btn btn-primary">Lanjut</a>
                                </div>
                            </div>
                        </div>
                    </div>
