...
<section class="panel">
    ...
    <center><h2 class="lead">Audit Tata Kelola Teknologi Informasi Menggunakan COBIT 4.1</h2></center>
    <div style="height: 100px;width: 600px;margin-left: 380px">
        ...
        <center><a href="<?= base_url() ?>auditor/topdown/" class="btn btn-lg btn-primary hidden-xs"> Top Down</a>
            <a href="<?= base_url() ?>auditor/buttomup/" class="btn btn-lg btn-success hidden-xs"> Buttom Up</a></center>
    </div>
